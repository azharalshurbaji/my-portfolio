        ...
        <div class="row">
            <div class="col mb-5">
                ...
                <div class="m-auto d-flex">
                    ...
                    <div class="font-style mt-md-4 ms-5">
...
export default {
    ...
    computed: {
        carouselItems() {
            return this.uiuxDetails.carouselItems[0],
            this.uiuxDetails.carouselItems[1],
            this.uiuxDetails.carouselItems[2],
            this.uiuxDetails.carouselItems[3]
        },
